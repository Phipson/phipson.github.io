        ...
        $(document).ready(function(){
            ...
            */
            ...
            $(".webmob-button").click(function() {
                ...
                $("#wmbutton").html(`<button onclick="transitionToPage('${WMButton[index]}')"><p>View More</p></button>`);
